...
<head>
    ...
    <title>Créer une Recette - Simple & Épuré</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="page-title">Créer une Recette</h1>
            <p class="page-subtitle">Partagez votre recette avec la communauté</p>
        </div>
        ...
        <div class="alert-success" id="successAlert">
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <span style="font-weight: 600;">Recette sauvegardée avec succès !</span>
            </div>
        </div>

        <form id="recipeForm" action="{{ route('addRecipe') }}" method="post">
             @csrf
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-input" placeholder="Ex: Tarte aux Pommes" required>
                    <div class="helper-text">Donnez un nom clair et appétissant</div>
                </div>

                <div class="form-group">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-textarea" placeholder="Décrivez votre recette..."></textarea>
                </div>
            ...
            <div class="card">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="number" name="prep_time" class="form-input" placeholder="30" min="0">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="difficulty-options">
                        <div class="difficulty-option" data-value="facile">
                            <div class="difficulty-icon">😊</div>
                            <div class="difficulty-label">Facile</div>
                        </div>
                        <div class="difficulty-option" data-value="moyen">
                            <div class="difficulty-icon">🤔</div>
                            <div class="difficulty-label">Moyen</div>
                        </div>
                        <div class="difficulty-option" data-value="difficile">
                            <div class="difficulty-icon">🎓</div>
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="image_url" id="imageUrlInput" class="form-input" placeholder="https://exemple.com/image.jpg">
            ...
            <div class="card">
                ...
                <div id="stepsList">
                    <div class="form-group">
                        ...
                        <textarea class="form-textarea" name="steps[0]" placeholder="Décrivez cette étape..." rows="3"></textarea>
                    </div>
                </div>
